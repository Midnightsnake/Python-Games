...
while True:
    ...
    if level == 1:
          ...
          AvailableJumps = drawplatform(BackgroundColors[PlatformColor][1], (590, 700, 10, 20), character, AvailableJumps)
          AvailableJumps = drawplatform(BackgroundColors[PlatformColor][1], (760, 550, 10, 20), character, AvailableJumps)
          AvailableJumps = drawplatform(BackgroundColors[PlatformColor][1], (930, 650, 10, 20), character, AvailableJumps)
          AvailableJumps = drawplatform(BackgroundColors[PlatformColor][1], (1100, 500, 10, 20), character, AvailableJumps)
          ...
          AvailableJumps = drawplatform(BackgroundColors[PlatformColor][1], (1550, 400, 10, 400), character, AvailableJumps)
          if character.position[0] >= 1450 and character.position[0] <= 1550 and character.position[1] >= 400 and character.position[1] <= 750:
             speedX = 0
